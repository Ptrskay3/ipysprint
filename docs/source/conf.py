...
# -*- coding: utf-8 -*-
#
# ipysprint documentation build configuration file
#
...
_version_py = os.path.join(repo, 'ipysprint', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipysprintdoc'
...
latex_documents = [
    (master_doc, 'ipysprint.tex', 'ipysprint Documentation',
     'Peter Leeh', 'manual'),
]
